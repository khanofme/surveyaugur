...
export class SideBarComponent implements OnInit {
  ...
  constructor(private userInfo:UserinfoService,private router:Router,changeDetectorRef: ChangeDetectorRef, media: MediaMatcher,private cookieService: CookieService) {
